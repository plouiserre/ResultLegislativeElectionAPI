...
class CandidateBusinessTest(unittest.TestCase) :
    ...
    def __get_candidates(self) : 
        ...
        fifth_candidate = factory.construct_candidate(5,"HERITIER", "Louise", "F", datetime.datetime(1997,2,25), 3, "Profession de l'information, des arts et des spectacles", False, 89787, 23.2, 12.2, 9872, 21.32, 6.2 )
    ...
    def test_get_all_candidates(self, mock_candidate_repository, mock_party_business) : 
        ...
        candidate_check =[5, "HERITIER", "Louise", "F", datetime.datetime(1997,2,25), 3, "Nouvelle union populaire écologique et sociale", "Profession de l'information, des arts et des spectacles", False, 89787, 23.2, 12.2, 9872, 21.32, 6.2]
