...
class DepartmentBusinessTest(unittest.TestCase):
    ...
    def test_get_departments(self, mock_repo):
        mock_repo.get_departments.return_value = getDepartments_by_ids([1, 2, 3, 33])
    ...
    def test_get_department_name_from_department_id(self, mock_dep_repo): 
        mock_dep_repo.get_departments.return_value = getDepartments_by_ids([1, 2, 3, 33])
    ...
    def test_get_departments_by_voting_rate_ascending(self, mock_department_repository, mock_district_repository, mock_result_business):
        mock_department_repository.get_departments.return_value = getDepartments_by_ids([1, 11, 33, 34, 69])
        mock_district_repository.get_districts.return_value = getDistricts_by_id([10, 11, 12, 110, 111, 330, 331, 340, 341, 342, 343, 690, 691, 692, 693])
    ...
    def test_get_departments_by_voting_rate_with_creuse_have_only_district_and_one_result(self, mock_department_repository, mock_district_repository, mock_result_business):
        mock_department_repository.get_departments.return_value = getDepartments_by_ids([1, 11])
        mock_district_repository.get_districts.return_value = getDistricts_by_id([10, 11, 12, 110, 111])
