...
class PartyResultByDepartmentBusinessTest(unittest.TestCase) :     
    ...
    def __assert_third_party_top_department(self, third_top_department) : 
        ...
        self.assert_test.assert_department_result_dto([11, "Aude", 11, 23.38], nup_departments_first_round[1]) 
        ...
        self.assert_test.assert_department_result_dto([11, "Aude", 11, 17.36], nup_departments_second_round[0])
        self.assert_test.assert_department_result_dto([33, "Gironde", 33, 17.98], nup_departments_second_round[1])
    ...
    def __assert_seven_party_top_department(self, seven_top_department) : 
        ...
        self.assert_test.assert_department_result_dto([69, "Rhône", 69, 20.06], ens_departments_first_round[0]) 
        self.assert_test.assert_department_result_dto([11, "Aude", 11, 23.22], ens_departments_first_round[1]) 
        self.assert_test.assert_department_result_dto([34, "Herault", 34, 24.55], ens_departments_first_round[2]) 
        self.assert_test.assert_department_result_dto([33, "Gironde", 33, 27.31], ens_departments_first_round[3]) 
        
        ens_departments_second_round = seven_top_department["second_round"]
        self.assert_test.assert_department_result_dto([69, "Rhône", 69, 18.24], ens_departments_second_round[0])
        self.assert_test.assert_department_result_dto([11, "Aude", 11, 24.62], ens_departments_second_round[1])
        self.assert_test.assert_department_result_dto([34, "Herault", 34, 28.62], ens_departments_second_round[2])
        self.assert_test.assert_department_result_dto([33, "Gironde", 33, 44.49], ens_departments_second_round[3])
    ...
    def __assert_eleven_party_top_department(self, eleven_top_department) : 
        ...
        self.assert_test.assert_department_result_dto([69, "Rhône", 69, 17.03], lr_departments_first_round[3]) 
        
        lr_departments_second_round = eleven_top_department["second_round"]
        self.assert_test.assert_department_result_dto([34, "Herault", 34, 0], lr_departments_second_round[0])
        self.assert_test.assert_department_result_dto([11, "Aude", 11, 0], lr_departments_second_round[1])
        self.assert_test.assert_department_result_dto([69, "Rhône", 69, 16.27], lr_departments_second_round[2])
        self.assert_test.assert_department_result_dto([33, "Gironde", 33, 21.09], lr_departments_second_round[3])
    ...
    def __assert_fifteen_party_top_department(self, fifteen_top_department) : 
        ...
        self.assert_test.assert_department_result_dto([69, "Rhône", 69, 20.87], rn_departments_first_round[0]) 
        ...
        self.assert_test.assert_department_result_dto([33, "Gironde", 33, 32.0], rn_departments_first_round[3]) 
        
        rn_departments_second_round = fifteen_top_department["second_round"]
        self.assert_test.assert_department_result_dto([69, "Rhône", 69, 0.0], rn_departments_second_round[0])
        self.assert_test.assert_department_result_dto([34, "Herault", 34, 37.15], rn_departments_second_round[1])
        self.assert_test.assert_department_result_dto([11, "Aude", 11, 50.44], rn_departments_second_round[2])
